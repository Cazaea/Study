...
import static com.hxd.study.app.Constants.EASYAR_PROJECT_VIDEO;
import static com.hxd.study.app.Constants.EASYAR_TEST_VIDEO;
...
public class HelloAR {
    ...
    public boolean initialize() {
        ...
        loadFromImage(tracker, "111-.jpg");
        loadFromImage(tracker, "222-.jpg");
                    ...
                    if (tracked_target == 0) {
                        if (video == null && video_renderers.size() > 0) {
                            ...
                            if (target_name.equals("argame") && video_renderers.get(0).texId() != 0) {
                                ...
                                video = new ARVideo();
                                video.openStreamingVideo(EASYAR_TEST_VIDEO, video_renderers.get(2).texId());
                                current_video_renderer = video_renderers.get(2);
                            }
                            else if (target_name.equals("111-") && video_renderers.get(3).texId() != 0) {
                                video = new ARVideo();
                                video.openStreamingVideo(EASYAR_PROJECT_VIDEO, video_renderers.get(3).texId());
                                current_video_renderer = video_renderers.get(3);
                            }
                            else if (target_name.equals("222-") && video_renderers.get(4).texId() != 0) {
                                video = new ARVideo();
                                video.openStreamingVideo(EASYAR_PROJECT_VIDEO, video_renderers.get(4).texId());
